...
export function UseLayout<P extends UseLayoutInjectedProps>(
    ...
    implements LayoutManager
  {
    ...
    empty() {
      const layout = new LayoutRect(uuid.v4(), 0, 1, Orientation.Horizontal);
      const pane = new PaneRect(uuid.v4(), 0, 1, Orientation.Horizontal);
