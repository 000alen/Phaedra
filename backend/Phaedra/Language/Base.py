...
answerer_prompt = pkg_resources.resource_string(__name__, "answer_prompt.txt").decode()
...
generator_prompt = pkg_resources.resource_string(__name__, "generation_prompt.txt")
